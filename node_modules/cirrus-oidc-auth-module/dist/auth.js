...
var requiredEnvVars = ['OPENID_CALLBACK', 'OPENID_CLIENT_ID', 'OPENID_CLIENT_SECRET', 'OPENID_ISSUER', 'OPENID_SCOPE', 'OPENID_TOKEN_URL', 'OPENID_USER_INFO_URL', 'OPENID_NONCE', 'COOKIE_SECRET'];
...
var authenticate = function authenticate(router) {
  ...
  router.get('/auth/callback', function (req, res) {
    ...
    authHelper.tokenEndpoint(req).then(function (response) {
